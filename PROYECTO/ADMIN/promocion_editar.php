...
<body>
    ...
    <div class="container">
        <h2 class="title">Edicion de Promociones</h2>
        <form enctype="multipart/form-data" name="editarLaPromocion" method="post">
            <div class="form-group">
                <label for="nombre">Nombre:</label>
                <input type="text" id="nombre" name="nombre" value="<?php echo $nombre; ?>" placeholder="Nombre de la promocion">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <a href="javascript:void(0);" onclick="editarPromocion(<?php echo $id ?>);" class="btn">Actualizar</a>
            </div>
